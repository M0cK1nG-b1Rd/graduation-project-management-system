...
INSERT INTO `dicts` VALUES (13, 3, '公告类型', '3', '已删除');
...
CREATE TABLE `given_subject`  (
  ...
  CONSTRAINT `given_subject_ibfk_2` FOREIGN KEY (`SUB_ID`) REFERENCES `subject` (`SUB_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
