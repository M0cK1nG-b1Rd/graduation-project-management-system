...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '验收老师' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `acceptance_teacher` VALUES (56, 5, 26, 1);
INSERT INTO `acceptance_teacher` VALUES (57, 1, 27, 1);
INSERT INTO `acceptance_teacher` VALUES (58, 2, 26, 0);
INSERT INTO `acceptance_teacher` VALUES (59, 3, 27, 0);
INSERT INTO `acceptance_teacher` VALUES (60, 4, 26, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '验收小组' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of acceptance_team
-- ----------------------------
INSERT INTO `acceptance_team` VALUES (1, 1, 'XT');
INSERT INTO `acceptance_team` VALUES (26, 1, 'JT');
INSERT INTO `acceptance_team` VALUES (27, 3, 'JT');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '选题' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of applied_subject
-- ----------------------------
INSERT INTO `applied_subject` VALUES (1, '1', 1, '2021-03-10 09:21:00', '略', '546546546', 'WTG', '你选个🔨', NULL, NULL);
INSERT INTO `applied_subject` VALUES (7, '1', 1, '2021-03-16 12:45:07', '<p>爱<span class=\"ql-size-huge\">哭鬼吧</span></p>', 'fa3619710878464fa866542e416b19ad', 'YTG', NULL, NULL, NULL);
INSERT INTO `applied_subject` VALUES (8, '1', 1, '2021-03-17 01:13:03', '<p>请输入申请<span class=\"ql-size-huge\">原因测试</span></p>', '0e8d688091214738bc09564c2e3a6fc9', 'WTG', NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `file_storage` VALUES ('456544465', 0, 8, 'abaaba', NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `file_storage` VALUES ('456544465', 0, 9, 'abaabaaba', NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `file_storage` VALUES ('456544465', 0, 10, 'test', NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `file_storage` VALUES ('546546546', 0, 11, 'test2', NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `file_storage` VALUES ('546546546', 0, 12, 'test3', NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO `file_storage` VALUES ('fa3619710878464fa866542e416b19ad', 0, 13, 'test4', NULL, NULL, NULL, 0, NULL, NULL);
...
-- ----------------------------
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 19:41:27', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 19:59:55', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:00:20', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:00:24', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:01:09', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:18:03', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('laoshi', '2021-03-15 20:20:54', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:31:32', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:32:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:35:45', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:46:43', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:46:46', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:46:47', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 20:56:15', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 21:01:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 21:36:17', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('dogshit', '2021-03-15 21:36:58', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('laoshi', '2021-03-15 21:40:35', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 22:22:07', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 22:27:05', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 22:27:30', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 22:31:25', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 22:32:36', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 23:12:25', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 23:38:53', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 23:40:35', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 23:41:34', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-15 23:55:15', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 00:15:00', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 08:59:11', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 09:06:32', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 09:45:21', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 09:53:23', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 10:08:45', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 10:14:14', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 10:32:26', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 14:08:52', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 15:32:41', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 15:59:27', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 16:31:05', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 11:47:56', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-16 11:52:41', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-16 20:14:04', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 12:24:07', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-16 12:40:05', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-16 21:26:53', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 21:51:20', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 23:01:31', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 23:01:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 15:02:34', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 23:38:17', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-16 15:41:47', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 00:56:32', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 01:06:20', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 01:06:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 09:09:23', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:18:16', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 01:41:14', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:33', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:34', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:34', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 09:52:34', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 01:53:57', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 02:53:31', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 11:31:01', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 12:40:07', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('stu1', '2021-03-17 14:37:51', NULL, '127.0.0.1');
INSERT INTO `login_log` VALUES ('admin', '2021-03-17 06:41:40', NULL, '127.0.0.1');
...
CREATE TABLE `plea`  (
  ...
  CONSTRAINT `plea_ibfk_2` FOREIGN KEY (`ACCEPTANCE_TEAM_ID`) REFERENCES `acceptance_team` (`TEAM_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '答辩' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of plea
-- ----------------------------
INSERT INTO `plea` VALUES (1, 'JT', 1, 1, 1, '2020-07-30 13:20:18');
...
-- Records of report
-- ----------------------------
INSERT INTO `report` VALUES (1, '1', 1, '456456', 'KT', '没啥意义', '没啥结果', '没啥计划', '没啥进度', '没啥后续计划', '1', '2021-03-17 10:54:56', 'WSH', NULL, NULL, NULL);

-- ----------------------------
-- Table structure for report_score
-- ----------------------------
DROP TABLE IF EXISTS `report_score`;
CREATE TABLE `report_score`  (
  `REPORT_ID` int NOT NULL,
  `FILE_SCORE` int NULL DEFAULT NULL,
  `FILE_SCORE_WEIGHT` double NULL DEFAULT NULL,
  `DEFENSE_SCORE` int NULL DEFAULT NULL,
  `DEFENSE_SCORE_WEIGHT` double NULL DEFAULT NULL,
  PRIMARY KEY (`REPORT_ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of report_score
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生小组，分批进行答辩' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `stu_group` VALUES (57, 0, 2, 'JT');
INSERT INTO `stu_group` VALUES (58, 1, 3, 'JT');
INSERT INTO `stu_group` VALUES (59, 0, 5, 'JT');
INSERT INTO `stu_group` VALUES (60, 1, 1, 'JT');
INSERT INTO `stu_group` VALUES (61, 0, 6, 'JT');
INSERT INTO `stu_group` VALUES (62, 1, 4, 'JT');
...
INSERT INTO `subject` VALUES (2, '124214234', '2', '上课开船', '一般来说， 我认为， 歌德曾经说过，读一本好书，就如同和一个高尚的人在交谈。这句话把我们带到了一个新的维度去思考这个问题: 那么， 在这种困难的抉择下，本人思来想去，寝食难安。 经过上述讨论， 现在，解决上班摸鱼的问题，是非常非常重要的。 所以， 这种事实对本人来说意义重大，相信对这个世界也是有一定意义的。 而这些并不是完全重要，更加重要的问题是， 一般来讲，我们都必须务必慎重的考虑考虑。 上班摸鱼的发生，到底需要如何做到，不上班摸鱼的发生，又会如何产生。 王阳明曾经说过，故立志者，为学之心也；为学者，立志之事也。这句话语虽然很短, 但令我浮想联翩。', '戴眼罩', 'KXTS', 2, NULL, '0', NULL, NULL, NULL, NULL);
INSERT INTO `subject` VALUES (14, NULL, 'ef3d55a7f0184c0688fe4d3cc13621e3', '我是啥币', '研究我自己', NULL, NULL, 2, '2021-03-15 20:27:39', '0', NULL, NULL, NULL, NULL);
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (10, 1, 1, '校长', 'https://baike.baidu.com/item/%E5%AE%8B%E6%B0%B8%E7%BA%A2/29205?fr=aladdin');
