...
CREATE TABLE `file_storage`  (
  ...
  `DEL_FLAG` tinyint(1) UNSIGNED ZEROFILL NULL DEFAULT NULL,
...
INSERT INTO `system_stage` VALUES (1, 4, '教师审核学生申请', '在该阶段，教师对学生提出的选题申请进行审核，需在规定时间内完成审核，审核结束前2天，讲发送信息提醒教师进行审核', '1900-01-19 00:05:43', '1900-01-20 00:05:43');
