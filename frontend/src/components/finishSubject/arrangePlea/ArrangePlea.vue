...
export default {
  ...
  methods: {
    ...
    async releaseAllArrange() {
      const { data: res } = await this.$http.put('/plea/true', { stage: 'JT' })
      if (res.meta.code === 200) {
        this.$message.success(res.meta.message)
      } else {
    ...
    async withdrawAllArrange() {
      const { data: res } = await this.$http.put('/plea/false', { stage: 'JT' })
      if (res.meta.code === 200) {
        this.$message.success(res.meta.message)
      } else {
        this.$message.error(res.meta.message)
    ...
    async deleteAllArrange() {
      const { data: res } = await this.$http.delete('/plea', { params: { stage: 'JT' } })
      if (res.meta.code === 200) {
        this.$message.success(res.meta.message)
      } else {
        this.$message.error(res.meta.message)
