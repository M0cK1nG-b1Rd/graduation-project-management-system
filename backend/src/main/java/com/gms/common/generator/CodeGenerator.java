package com.gms.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://ij36895496.wicp.vip:28695/gms?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "suncaper";
    // @author 值
    private static final String AUTHOR = "MrBird";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.gms";
    // xml文件路径
